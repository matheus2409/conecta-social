...
if (esporte === 'kung_fu') {
	...
	if (esporte === 'ciclismo') {
		window.open('https://www.google.com/maps/search/ciclismo+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
if (esporte === 'corrida') {
		window.open('https://www.google.com/maps/search/corrida+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
	...
	if (esporte === 'natacao') {
		window.open('https://www.google.com/maps/search/natacao+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
	if (esporte === 'mergulho') {
		window.open('https://www.google.com/maps/search/mergulho+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
	if (esporte === 'surfe') {
		window.open('https://www.google.com/maps/search/surfe+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
	if (esporte === 'kite_surf') {
		window.open('https://www.google.com/maps/search/kitesurf+são+jose+do+rio+preto/@-20.7937139,-49.4952541,11z/data=!5m1!1e1?entry=ttu&g_ep=EgoyMDI1MTAwOC4wIKXMDSoASAFQAw%3D%3D', '_blank');
		return;
	}
